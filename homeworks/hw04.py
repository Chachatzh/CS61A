...
def make_withdraw(balance, password):
    ...
    def withdraw(amount, attempt):
        nonlocal balance, incorrect_times
        
        if attempt != password and incorrect_times < 3:
            incorrect_try.append(attempt)
            incorrect_times += 1
            return "Incorrect password"
        elif incorrect_times >= 3:
            return "Your account is locked. Attempts: " + str(incorrect_try)
        elif amount > balance:
